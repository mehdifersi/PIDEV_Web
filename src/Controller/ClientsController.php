...
class ClientsController extends AbstractController
{
    ...
    public function edit(Request $request, Clients $client, ClientRepository $clientRepository): Response
    {
        $form = $this->createForm(ClientsType::class, $client);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Clients $client, ClientRepository $clientRepository): Response
    {
