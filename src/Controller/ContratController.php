...
class ContratController extends AbstractController
{
    ...
    public function contratdompdf(Contrat $contrat,Request $request, EntityManagerInterface $entityManager, \Knp\Snappy\Pdf $knpSnappyPdf):Response

    {
        ...
        $filename='contrat'.$contrat->getReference();
        $knpSnappyPdf->generateFromHtml(
            ...
            'C:/Users/GAMING/Desktop/'.$filename.'.pdf'
        );
