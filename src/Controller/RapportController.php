...
class RapportController extends AbstractController
{
 ...
 #[Route('/ra', name: 'app_rapportra_index', methods: ['GET'])]
    public function index1(RapportRepository $rapportRepository): Response
    {
        return $this->render('rapport/index1.html.twig', [
            'rapports' => $rapportRepository->findAll(),
        ]);
    }
    ...
    #[Route('/{idrapport}', name: 'app_rapport_show', methods: ['GET'])]
    ...
    #[Route('/{idrapport}/edit', name: 'app_rapport_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idrapport}', name: 'app_rapport_delete', methods: ['POST'])]
    public function delete(Request $request, Rapport $rapport, RapportRepository $rapportRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$rapport->getIdrapport(), $request->request->get('_token'))) {
