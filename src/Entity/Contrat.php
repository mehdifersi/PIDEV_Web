 ...
 * Contrat
 *
 * @ORM\Table(name="contrat", indexes={@ORM\Index(name="Fk_ContratVendeur", columns={"vendeur"}), @ORM\Index(name="FK_6034999373A85B93", columns={"propriete"}), @ORM\Index(name="fk_contrat_agent", columns={"agent"}), @ORM\Index(name="FK_contratClient", columns={"client"})})
...
class Contrat
{
    ...
    public function setVendeur(?Users $vendeur): self
    {
