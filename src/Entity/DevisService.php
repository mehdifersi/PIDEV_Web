 ...
 * DevisService
 *
 * @ORM\Table(name="devis_service", indexes={@ORM\Index(name="id_prestataitre", columns={"id_prestataitre"}), @ORM\Index(name="FK_7373018EF8097ED5", columns={"id_demande"}), @ORM\Index(name="id_client", columns={"id_client"})})
