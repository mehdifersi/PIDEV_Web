 ...
 * DevisService
 *
 * @ORM\Table(name="devis_service", indexes={@ORM\Index(name="fk_devis_service_demande22", columns={"id_demande"}), @ORM\Index(name="id_client", columns={"id_client"}), @ORM\Index(name="id_prestataitre", columns={"id_prestataitre"})})
 * @ORM\Entity
 */
class DevisService
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="valable_jusqu_a", type="date", nullable=false)
     */
    private $valableJusquA;
     ...
     * @var \DemandesDevis
     *
     * @ORM\ManyToOne(targetEntity="DemandesDevis")
     * @ORM\JoinColumns({
    ...
    public function getValableJusquA(): ?\DateTimeInterface
    {
        return $this->valableJusquA;
    }

    public function setValableJusquA(\DateTimeInterface $valableJusquA): self
    {
        $this->valableJusquA = $valableJusquA;
    ...
    public function getIdDemande(): ?DemandesDevis
    {
        return $this->idDemande;
    }

    public function setIdDemande(?DemandesDevis $idDemande): self
    {
